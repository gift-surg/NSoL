##
# \file run_deconvolution_study_test.py
#  \brief  Class to test deconvolution study script
#
...
class RunDeconvolutionStudy(unittest.TestCase):
    ...
    def run_reconstruction_2d(self, reconstruction_type):
        ...
        cmd = "nsol_run_deconvolution_study %s" % (" ").join(cmd_args)
